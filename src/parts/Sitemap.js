        ...
        <aside className="container mx-auto">
          <div className="flex flex-wrap -mx-4 justify-center">
            ...
            <div className="px-4 w-full md:w-2/12 mb-4 md:mb-0 accordion">
              ...
              <ul className="h-0 invisible md:h-auto md:visible overflow-hidden">
                <li>
                  <Link to="/term-and-condition" className="hover:underline py-1 block">Terms & Conds</Link>
                </li>
                <li>
                  <Link to="/privacy-policy" className="hover:underline py-1 block">Privacy Policy</Link>
                </li>
                <li>
                  <Link to="/for-developer" className="hover:underline py-1 block">For Developer</Link>
                </li>
              </ul>
            </div>
